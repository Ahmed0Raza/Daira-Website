...
const ApprovedTeamDetails = ({token}) => {
  ...
  const { getApprovedTeamInfo } = useRegistrationAgent();

  useEffect(() => {
    const fetchApprovedTeams = async () => {
      setLoading(true);
      try {
        const result = await getApprovedTeamInfo(token);
        if (result?.teams) {
                  ...
                  <Box sx={{ p: 2, backgroundColor: '#f9f9f9' }}>
                    ...
                    <TableContainer component={Paper} variant="outlined">
                      <Table size="small">
                        <TableBody>
                          <TableRow>
                            <TableCell sx={{ backgroundColor: '#ffc107', fontWeight: 'bold' }}>Registrant Name</TableCell>
                            <TableCell>{team.registeredBy.name}</TableCell>
                          </TableRow>
                          <TableRow>
                            <TableCell sx={{ backgroundColor: '#ffc107', fontWeight: 'bold' }}>Registrant Email</TableCell>
                            <TableCell>{team.registeredBy.email}</TableCell>
                          </TableRow>
                          <TableRow>
                            <TableCell sx={{ backgroundColor: '#ffc107', fontWeight: 'bold' }}>Team Name</TableCell>
                            <TableCell>{team.team.name}</TableCell>
                          </TableRow>
                          <TableRow>
                            <TableCell sx={{ backgroundColor: '#ffc107', fontWeight: 'bold' }}>Event</TableCell>
                            <TableCell>{team.event.name}</TableCell>
                          </TableRow>
                          <TableRow>
                            <TableCell sx={{ backgroundColor: '#ffc107', fontWeight: 'bold' }}>Category</TableCell>
                    ...
                    <TableContainer component={Paper} variant="outlined">
                      <Table size="small">
                        <TableHead>
                          <TableRow>
                            <TableCell sx={{ backgroundColor: '#ffc107', fontWeight: 'bold' }}>Name</TableCell>
                            <TableCell sx={{ backgroundColor: '#ffc107', fontWeight: 'bold' }}>CNIC</TableCell>
                            <TableCell sx={{ backgroundColor: '#ffc107', fontWeight: 'bold' }}>Contact Number</TableCell>
                          </TableRow>
                        </TableHead>
                        <TableBody>
...
export default ApprovedTeamDetails;
